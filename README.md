This is the Had Task, bootstrapped using [`@react-native-community/cli`](https://github.com/react-native-community/cli).
...
2. React-query: A global state management
...
4. React Native fast image: handles image caching
